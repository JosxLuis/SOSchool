<template>
    <div class="school-map">
        ...
        viewBox="0 0 1165 986" style="enable-background:new 0 0 1165 986;" xml:space="preserve">
            ...
            <g id="Textos">
                <text x="490" y="480" font-size="2em" font-weight="bold" fill="black">Cafeteria</text>
                <text x="845" y="810" font-size="1.2em" font-weight="bold" fill="black">Baño hombres</text>
                <text x="1005" y="900" font-size="1.2em" font-weight="bold" fill="black">Baño mujeres</text>
                <text x="415" y="865" font-size="1.8em" font-weight="bold" fill="black">Salón de artes</text>
                <text x="670" y="135" font-size="1.8em" font-weight="bold" fill="black">Gym</text>
                <text x="275" y="135" font-size="1.8em" font-weight="bold" fill="black">Dirección</text>
                <text x="65" y="890" font-size="1.8em" font-weight="bold" fill="black">Biblioteca</text>
                <text x="50" y="150" font-size="1.8em" font-weight="bold" fill="black">Salón 1</text>
                <text x="50" y="350" font-size="1.8em" font-weight="bold" fill="black">Salón 2</text>
                <text x="50" y="570" font-size="1.8em" font-weight="bold" fill="black">Salón 3</text>
                <text x="962" y="150" font-size="1.8em" font-weight="bold" fill="black">Salón 6</text>
                <text x="962" y="370" font-size="1.8em" font-weight="bold" fill="black">Salón 5</text>
                <text x="962" y="570" font-size="1.8em" font-weight="bold" fill="black">Salón 4</text>
            </g>
            <g id="Salidas">
