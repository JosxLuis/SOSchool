<template>
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 1165 986" style="enable-background:new 0 0 1165 986;" xml:space="preserve">
        ...
        <g id="Salon_12">
            <rect x="840.5" y="712.5" class="st0" width="141" height="180" @click="onClick(12)"/>
        </g>
        <g id="Salon_11">
            <rect x="564.5" y="33.5" class="st0" width="286" height="180" @click="onClick(11)"/>
        </g>
        <g id="Salon_10">
            <rect x="201.5" y="33.5" class="st0" width="286" height="180" @click="onClick(10)"/>
        </g>
        <g id="Salon_9">
            <rect x="928.5" y="41.5" class="st0" width="174" height="200" @click="onClick(9)"/>
        </g>
        <g id="Salon_8">
            <rect x="928.5" y="252.5" class="st0" width="174" height="200" @click="onClick(8)"/>
        </g>
        <g id="Salon_7">
            <rect x="928.5" y="463.5" class="st0" width="174" height="188" @click="onClick(7)"/>
        </g>
        <g id="Salon_6">
            <rect x="986.5" y="819.5" class="st0" width="163" height="151" @click="onClick(6)"/>
        </g>
        <g id="Salon_5">
            <rect x="340.5" y="724.5" class="st0" width="348" height="246" @click="onClick(5)"/>
        </g>
        <g id="Salon_4">
            <rect x="15.5" y="783.5" class="st0" width="257" height="187" @click="onClick(4)"/>
        </g>
        <g id="Salon_3">
            <rect x="15.5" y="429.5" class="st0" width="177" height="266" @click="onClick(3)"/>
        </g>
        <g id="Salon_2">
            <rect x="15.5" y="253.5" class="st0" width="177" height="169" @click="onClick(2)"/>
        </g>
        <g id="Salon_1">
            <rect x="15.5" y="33.5" class="st0" width="177" height="213" @click="onClick(1)"/>
        </g>
        <g id="Cafeteria">
            <rect x="282.5" y="284.5" class="st0" width="555" height="359" @click="onClick('cafeteria')"/>
        </g>
        <g id="Muros">
