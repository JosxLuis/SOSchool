...
var il = (e, t, a) => t in e ? rl(e, t, { enumerable: true, configurable: true, writable: true, value: a }) : e[t] = a;
...
var ut = (e, t) => Object.keys(e).filter((a) => !t.includes(a)).reduce((a, l) => ({ ...a, [l]: e[l] }), {});
var Ee = () => ({ enumerable: true, configurable: false, writable: false });
...
var Ct = (e) => new Promise((t) => t(lt(e)));
var dt = class {
  constructor(t, a = {}) {
    fe(this, "cancelable", true);
    fe(this, "componentId", null);
    fe(this, "defaultPrevented", false);
...
var wl = (e) => e !== null && typeof e == "object";
var ua = (e) => /^[0-9]*\.?[0-9]+$/.test(String(e));
var da = (e) => Object.prototype.toString.call(e) === "[object Object]";
var ca = /_/g;
var fa = /([a-z])([A-Z])/g;
var Tl = /(\s|^)(\w)/g;
var Vl = /(\s|^)(\w)/;
...
var _l = /^#/;
var Al = /^#[A-Za-z]+[\w\-:.]*$/;
var wt = (e, t = 2) => typeof e == "string" ? e : e == null ? "" : Array.isArray(e) || da(e) && e.toString === Object.prototype.toString ? JSON.stringify(e, null, t) : String(e);
var jt = (e) => e.replace(ca, " ").replace(fa, (t, a, l) => `${a} ${l}`).replace(Vl, (t, a, l) => a + l.toUpperCase());
var Mt = (e) => e.replace(ca, " ").replace(fa, (t, a, l) => `${a} ${l}`).replace(Tl, (t, a, l) => a + l.toUpperCase());
var xl = (e) => {
  const t = e.trim();
...
var va = typeof window < "u";
var ma = typeof document < "u";
var Fl = typeof navigator < "u";
var Ol = va && ma && Fl;
var ba = ma ? document : {};
var Pe = (e) => !!(e && e.nodeType === Node.ELEMENT_NODE);
var zl = (e) => Pe(e) ? e.getBoundingClientRect() : null;
var Pl = (e = []) => {
...
var El = (e, t) => t && Pe(e) && e.getAttribute(t) || null;
var Hl = (e) => {
...
var Gt = (e, t) => !e || e(t).filter((a) => a.type !== Comment).length < 1;
var Dl = (e, t) => (Pe(t) ? t : ba).querySelector(e) || null;
var ql = (e, t) => Array.from([(Pe(t) ? t : ba).querySelectorAll(e)]);
var ga = (e, t) => t && Pe(e) ? e.getAttribute(t) : null;
var Rl = (e, t, a) => {
...
var Ml = (e, t) => wt(e).toLowerCase() === wt(t).toLowerCase();
var Ze = va ? window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || ((e) => setTimeout(e, 16)) : (e) => setTimeout(e, 0);
var ct = (e, t, a) => t.concat(["sm", "md", "lg", "xl", "xxl"]).reduce((l, n) => (l[e ? `${e}${n.charAt(0).toUpperCase() + n.slice(1)}` : n] = a, l), /* @__PURE__ */ Object.create(null));
var pa = (e, t, a, l = a) => Object.keys(t).reduce((n, i) => (e[i] && n.push(
  [l, i.replace(a, ""), e[i]].filter((c) => c && typeof c != "boolean").join("-").toLowerCase()
), n), []);
var xe = (e = "") => `__BVID__${Math.random().toString().slice(2, 8)}___BV_${e}__`;
var ft = (e, t) => e === true || e === "true" || e === "" ? "true" : e === "grammar" || e === "spelling" ? e : t === false ? "true" : e === false || e === "false" ? "false" : void 0;
...
var Ut = (e, t) => t + (e ? xl(e) : "");
var Nt = (e, t) => (Array.isArray(t) ? t.slice() : Object.keys(t)).reduce(
  (a, l) => (a[l] = e[l], a),
  {}
);
var Gl = (e) => typeof e == "boolean" ? e : e === "" ? true : e === "true";
var Xe = (e) => !!(e.href || e.to);
function r(e) {
  return computed(() => e.value === void 0 ? void 0 : Gl(e.value));
}
var ha = Symbol();
var ya = {
  items: reactive([]),
...
var he = (e, t) => computed(() => (e == null ? void 0 : e.value) || xe(t));
var Va = {
  ariaInvalid: {
    type: [Boolean, String],
    default: void 0
...
var _a = (e, t) => {
  const a = ref();
  let l = null, n = true;
  const i = he(toRef(e, "id"), "input"), c = (y, S, $ = false) => (y = String(y), typeof e.formatter == "function" && (!e.lazyFormatter || $) ? (n = false, e.formatter(y, S)) : y), f = (y) => e.trim ? y.trim() : e.number ? Number.parseFloat(y) : y, v = () => {
    nextTick(() => {
      var y;
  ...
  const b = computed(
    ...
    if (t("blur", y), !e.lazy && !e.lazyFormatter)
      return;
    const { value: S } = y.target, $ = c(S, y, true);
    l = S, t("update:modelValue", $);
  }, k = () => {
    var y;
...
var Lt = (e, t, a) => Array.isArray(e) ? e.map((l) => $t(l, null, t, a)) : Object.prototype.toString.call(e) === "[object Object]" ? (console.warn(
...
var Kl = defineComponent({
  ...
  setup(e) {
    const t = e, a = he(toRef(t, "id"), "accordion"), l = r(toRef(t, "flush")), n = r(toRef(t, "free")), i = computed(() => ({
      "accordion-flush": l.value
    }));
    return n.value || provide(Aa, a.value.toString()), (c, f) => (openBlock(), createElementBlock("div", {
      id: unref(a),
...
var xa = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "modelValue")), n = r(toRef(a, "toggle")), i = r(toRef(a, "visible")), c = r(toRef(a, "isNav")), f = ref(), v = ref(), b = computed(() => ({
      show: l.value,
    ...
    }), ve(f, "shown.bs.collapse", () => t("shown")), ve(f, "hidden.bs.collapse", () => t("hidden")), onMounted(() => {
      var B;
      v.value = new Collapse(f.value, {
    ...
    ), (B, p) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      id: e.id,
      ref_key: "element",
      ref: f,
...
var tn = (e, t) => t != null && t.placement ? t.placement : e.left ? "left" : e.right ? "right" : e.bottom ? "bottom" : "top";
var an = (e) => e != null && e.delay ? e.delay : 0;
var Wt = (e) => typeof e == "object" ? e == null ? void 0 : e.title : e;
var ln = {
  beforeMount(e, t) {
...
var un = { class: "accordion-item" };
var dn = ["id"];
var cn = ["aria-expanded", "aria-controls"];
var fn2 = { class: "accordion-body" };
var vn = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "visible")), l = he(toRef(t, "id"), "accordion_item"), n = inject(Aa, "");
    return (i, c) => (openBlock(), createElementBlock("div", un, [
      createBaseVNode("h2", {
        id: `${unref(l)}heading`,
...
var mn = ["type", "disabled", "aria-label"];
var Ge = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    return (c, f) => (openBlock(), createElementBlock("button", {
      type: e.type,
...
var bn = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    r(toRef(a, "fade"));
    const n = r(toRef(a, "show")), i = ref(null), c = ref(), f = computed(() => ({
    ...
    }, B = ref(b(a.modelValue)), p = computed(() => !!a.modelValue || n.value);
    onBeforeUnmount(() => {
      var S;
      g(), (S = c.value) == null || S.dispose(), c.value = void 0;
    });
    const k = computed(() => a.modelValue === true ? true : a.modelValue === false || je(a.modelValue, 0) < 1 ? false : !!a.modelValue), C = () => {
      B.value = b(a.modelValue), (k.value || n.value) && !c.value && (c.value = new Alert(i.value));
    }, y = () => {
      typeof a.modelValue == "boolean" ? t("update:modelValue", false) : t("update:modelValue", 0), t("closed");
    };
    return watch(() => a.modelValue, C), watch(() => n.value, C), watch(B, (S) => {
    ...
    }), (S, $) => unref(p) ? (openBlock(), createElementBlock("div", {
      key: 0,
      ref_key: "element",
      ref: i,
      class: normalizeClass(["alert", unref(f)]),
      role: "alert"
    }, [
      renderSlot(S.$slots, "default"),
      unref(l) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
        S.$slots.close ? (openBlock(), createElementBlock("button", {
          key: 0,
          type: "button",
...
var gn = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "square")), l = computed(() => Vt(t.size)), n = (f) => typeof f == "string" && ua(f) ? Pt(f, 0) : f || 0, i = computed(
    ...
    return provide(Fa, {
      ...
      rounded: t.rounded,
      variant: t.variant
    }), (f, v) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
...
var Bn = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "badgeLeft")), n = r(toRef(a, "badgeTop")), i = r(toRef(a, "button")), c = r(toRef(a, "disabled")), f = r(toRef(a, "square")), v = useSlots(), b = ["sm", null, "lg"], g = 0.4, B = g * 0.7, p = inject(Fa, null), k = (ee) => {
      const Z = ee;
      return Z === "light" || Z === "warning" ? "dark" : "light";
    }, C = computed(() => !Gt(v.default)), y = computed(() => !Gt(v.badge)), S = computed(
    ...
    }), ae = computed(() => i.value ? "button" : "span"), K = computed(() => ({
      ...ne.value,
      width: $.value,
      height: $.value
    })), de = (ee) => {
    ...
    return (ee, Z) => (openBlock(), createBlock(resolveDynamicComponent(unref(ae)), mergeProps({
      class: ["b-avatar", unref(_)],
      style: unref(K)
    }, unref(V), { onClick: de }), {
      default: withCtx(() => [
        unref(C) ? (openBlock(), createElementBlock("span", pn, [
          renderSlot(ee.$slots, "default")
        ])) : e.src ? (openBlock(), createElementBlock("span", hn, [
          createBaseVNode("img", {
            src: e.src,
            alt: e.alt,
            onError: se
        ...
        unref(S) ? (openBlock(), createElementBlock("span", {
          ...
          unref(y) ? renderSlot(ee.$slots, "badge", { key: 0 }) : (openBlock(), createElementBlock("span", {
            key: 1,
...
var $n = defineComponent({
  ...
  setup(e, { emit: t, attrs: a }) {
    const l = r(toRef(e, "active")), n = r(toRef(e, "append")), i = r(toRef(e, "disabled")), c = r(toRef(e, "exact")), f = r(toRef(e, "replace")), v = getCurrentInstance(), b = ref(null), g = computed(() => {
...
function kn(e, t, a, l, n, i) {
  return e.tag === "router-link" ? (openBlock(), createBlock(resolveDynamicComponent(e.tag), mergeProps({ key: 0 }, e.routerAttr, { custom: "" }), {
    default: withCtx(({ href: c, navigate: f, isActive: v, isExactActive: b }) => [
...
var Ce = Be($n, [["render", kn]]);
var Kt = ut(De, ["event", "routerTag"]);
...
var wn = Be(Sn, [["render", Cn]]);
var Jt = ut(De, ["event", "routerTag"]);
...
var Oa = Be(Tn, [["render", Vn]]);
var _n = { "aria-label": "breadcrumb" };
var An = { class: "breadcrumb" };
var xn = defineComponent({
  ...
  setup(e) {
    const t = e, a = Wl(), l = computed(() => {
      const n = t.items || (a == null ? void 0 : a.items) || [];
      let i = false;
      return n.map((f, v) => (typeof f == "string" && (f = { text: f }, v < n.length - 1 && (f.href = "#")), f.active && (i = true), !f.active && !i && (f.active = v + 1 === n.length), f));
    });
    return (n, i) => (openBlock(), createElementBlock("nav", _n, [
      createBaseVNode("ol", An, [
        renderSlot(n.$slots, "prepend"),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(l), (c, f) => (openBlock(), createBlock(Oa, mergeProps({ key: f }, c), {
          default: withCtx(() => [
...
var Ht = defineComponent({
  ...
  setup(e) {
    ...
    return (n, i) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      ...
      default: withCtx(() => [
        e.label || n.$slots.label ? (openBlock(), createElementBlock("span", In, [
...
var Fn = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = r(toRef(e, "active")), l = r(toRef(e, "disabled")), n = r(toRef(e, "pill")), i = r(toRef(e, "pressed")), c = r(toRef(e, "squared")), f = r(toRef(e, "loading")), v = computed(() => i.value === true), b = computed(
      () => e.tag === "button" && e.href === void 0 && e.to === null
    ), g = computed(() => Xe(e)), B = computed(() => e.to !== null), p = computed(
...
var Dt = defineComponent({
  ...
  emits: ["load"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "lazy")), n = r(toRef(a, "blank")), i = r(toRef(a, "block")), c = r(toRef(a, "center")), f = r(toRef(a, "fluid")), v = r(toRef(a, "fluidGrow")), b = r(toRef(a, "left")), g = r(toRef(a, "start")), B = r(toRef(a, "right")), p = r(toRef(a, "end")), k = r(toRef(a, "thumbnail")), C = '<svg width="%{w}" height="%{h}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 %{w} %{h}" preserveAspectRatio="none"><rect width="100%" height="100%" style="fill:%{f};"></rect></svg>', y = (M, _, T) => `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(
    ...
    return (M, _) => (openBlock(), createElementBlock("img", mergeProps({ class: unref(I) }, unref(V), {
...
var ot = defineComponent({
  ...
  emits: ["load"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "bottom")), n = r(toRef(a, "end")), i = r(toRef(a, "left")), c = r(toRef(a, "right")), f = r(toRef(a, "start")), v = r(toRef(a, "top")), b = computed(
    ...
    return (p, k) => (openBlock(), createBlock(Dt, mergeProps({ class: unref(B) }, unref(g), {
    ...
    return (l, n) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      ...
      default: withCtx(() => [
        e.html ? (openBlock(), createElementBlock("div", {
          key: 0,
          innerHTML: e.html
        }, null, 8, Ln)) : renderSlot(l.$slots, "default", { key: 1 }, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
      ]),
      _: 3
...
var Pa = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createBlock(za, mergeProps({ class: "card-header" }, t.$props), {
      default: withCtx(() => [
...
var Ea = defineComponent({
  ...
  setup(e) {
    ...
    return (n, i) => (openBlock(), createBlock(resolveDynamicComponent(e.bodyTag), {
      ...
      default: withCtx(() => [
        !!e.title || n.$slots.title ? (openBlock(), createBlock(Na, {
          key: 0,
          tag: e.titleTag
        }, {
          default: withCtx(() => [
        ...
        !!e.subtitle || !!n.$slots.subtitle ? (openBlock(), createBlock(La, {
          key: 1,
          tag: e.subtitleTag,
...
var Ha = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createBlock(za, mergeProps({ class: "card-footer" }, t.$props), {
      default: withCtx(() => [
        renderSlot(t.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
...
var Da = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "imgBottom")), l = r(toRef(t, "imgEnd")), n = r(toRef(t, "imgLeft")), i = r(toRef(t, "imgRight")), c = r(toRef(t, "imgStart")), f = r(toRef(t, "noBody")), v = computed(() => ({
    ...
    return (k, C) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      class: normalizeClass(["card", unref(v)])
    }, {
      default: withCtx(() => [
        unref(a) ? createCommentVNode("", true) : renderSlot(k.$slots, "img", { key: 0 }, () => [
          e.imgSrc ? (openBlock(), createBlock(ot, normalizeProps(mergeProps({ key: 0 }, unref(p))), null, 16)) : createCommentVNode("", true)
        ]),
        e.header || k.$slots.header || e.headerHtml ? (openBlock(), createBlock(Pa, mergeProps({ key: 1 }, unref(b), { class: e.headerClass }), {
          default: withCtx(() => [
        ...
        unref(f) ? renderSlot(k.$slots, "default", { key: 3 }, () => [
          createTextVNode(toDisplayString(e.bodyText), 1)
        ]) : (openBlock(), createBlock(Ea, mergeProps({ key: 2 }, unref(g), { class: e.bodyClass }), {
          default: withCtx(() => [
        ...
        e.footer || k.$slots.footer || e.footerHtml ? (openBlock(), createBlock(Ha, mergeProps({ key: 4 }, unref(B), { class: e.footerClass }), {
          default: withCtx(() => [
...
var En = defineComponent({
  ...
  setup(e) {
    ...
    return (c, f) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
...
var jn = { class: "carousel-inner" };
var Mn = ["data-bs-target"];
var Gn = createBaseVNode("span", {
  class: "carousel-control-prev-icon",
  "aria-hidden": "true"
}, null, -1);
var Un = { class: "visually-hidden" };
var Wn = ["data-bs-target"];
var Xn = createBaseVNode("span", {
  class: "carousel-control-next-icon",
  "aria-hidden": "true"
}, null, -1);
var Kn = { class: "visually-hidden" };
var qa = Symbol();
var Jn = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    r(toRef(a, "noWrap"));
    const c = useSlots(), f = ref(), v = ref(), b = he(toRef(a, "id"), "carousel"), g = ref([]);
    return ve(f, "slide.bs.carousel", (B) => t("sliding-start", B)), ve(f, "slid.bs.carousel", (B) => t("sliding-end", B)), onMounted(() => {
      v.value = new Carousel(f.value, {
        wrap: !i.value,
        interval: a.interval,
        touch: !i.value
      ...
      width: a.imgWidth,
      height: a.imgHeight
    }), (B, p) => (openBlock(), createElementBlock("div", {
      id: unref(b),
      ref_key: "element",
      ref: f,
      ...
      unref(n) ? (openBlock(), createElementBlock("div", qn, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(g.value, (k, C) => (openBlock(), createElementBlock("button", {
          key: C,
          type: "button",
          "data-bs-target": `#${unref(b)}`,
          "data-bs-slide-to": C,
          class: normalizeClass(C === e.startingSlide ? "active" : ""),
          "aria-current": "true",
      ...
      unref(l) ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        createBaseVNode("button", {
          ...
          Gn,
          createBaseVNode("span", Un, toDisplayString(e.controlsPrevText), 1)
        ], 8, Mn),
        createBaseVNode("button", {
          ...
          Xn,
          createBaseVNode("span", Kn, toDisplayString(e.controlsNextText), 1)
        ], 8, Wn)
      ], 64)) : createCommentVNode("", true)
    ], 8, Dn));
  }
});
var Yn = ["data-bs-interval"];
var Zn = ["innerHTML"];
var Qn = { key: 1 };
var eo = ["innerHTML"];
var to = { key: 1 };
var ao = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "active")), l = r(toRef(t, "imgBlank")), n = inject(qa, {});
    computed(
    ...
    })), f = computed(() => n.width), v = computed(() => n.height);
        ...
        default: withCtx(() => [
          e.caption || e.captionHtml ? (openBlock(), createBlock(resolveDynamicComponent(e.captionTag), { key: 0 }, {
            default: withCtx(() => [
              ...
              }, null, 8, Zn)) : (openBlock(), createElementBlock("span", Qn, toDisplayString(e.caption), 1))
            ]),
            _: 1
          })) : createCommentVNode("", true),
          e.text || e.textHtml ? (openBlock(), createBlock(resolveDynamicComponent(e.textTag), { key: 1 }, {
            default: withCtx(() => [
              ...
              }, null, 8, eo)) : (openBlock(), createElementBlock("span", to, toDisplayString(e.text), 1))
            ]),
            _: 1
          })) : createCommentVNode("", true),
          renderSlot(b.$slots, "default")
...
var Yt = ct("", [], { type: [Boolean, String, Number], default: false });
var Zt = ct("offset", [""], { type: [String, Number], default: null });
var Qt = ct("order", [""], { type: [String, Number], default: null });
...
var st = defineComponent({
  ...
  setup(e, { slots: t }) {
    const a = r(toRef(e, "appear")), l = r(toRef(e, "noFade")), n = ref(e.transProps);
...
var ja = defineComponent({
  ...
  setup(e, { emit: t, slots: a }) {
    r(toRef(e, "animation"));
    const l = r(toRef(e, "isStatus")), n = r(toRef(e, "autoHide")), i = r(toRef(e, "noCloseButton")), c = r(toRef(e, "noFade")), f = r(toRef(e, "noHoverPause"));
    r(toRef(e, "solid")), r(toRef(e, "static"));
    const v = r(toRef(e, "modelValue")), b = ref(false), g = ref(false), B = ref(false), p = computed(() => ({
    ...
    const S = () => {
      ...
      v.value && (C = y = 0, S(), g.value = true, Ze(() => {
        B.value = false;
      }));
    }, L = () => {
      S(), t("update:modelValue", true), C = y = 0, g.value = false, nextTick(() => {
        Ze(() => {
          B.value = true;
        });
      });
    ...
    const I = () => {
      ...
      b.value = false, y = C = 0, t("update:modelValue", false);
    };
    onUnmounted(() => {
    ...
    return () => {
      const ne = () => {
        ...
        K ? ae.push(h(K)) : e.title && ae.push(h("strong", { class: "me-auto" }, e.title)), !i.value && ae.length !== 0 && ae.push(
          h(Ge, {
            class: ["btn-close"],
            onClick: () => {
              z();
  ...
  setup(e) {
    ...
    return (i, c) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList((f = e.instance) == null ? void 0 : f.toasts(e.position).value, (v) => (openBlock(), createBlock(ja, {
          id: v.options.id,
          key: v.options.id,
...
var qe = { delay: 5e3, value: true, pos: "top-right" };
var ta = class {
  constructor(t) {
    fe(this, "vm");
  ...
  setup(e, { slots: t, expose: a }) {
    ...
    return onMounted(() => {
      ...
      return n == null || n.containerPositions.value.forEach((v) => {
        c.push(h(_t, { key: v, instance: n, position: v }));
...
var Ua = defineComponent({
  ...
  setup(e, { expose: t, emit: a }) {
    const l = e, n = r(toRef(l, "block")), i = r(toRef(l, "dark")), c = r(toRef(l, "disabled")), f = r(toRef(l, "dropup")), v = r(toRef(l, "dropright")), b = r(toRef(l, "isNav")), g = r(toRef(l, "dropleft")), B = r(toRef(l, "right")), p = r(toRef(l, "split")), k = r(toRef(l, "noCaret")), C = ref(), y = ref(), S = ref(), $ = he(toRef(l, "id"), "dropdown");
    ...
    return onMounted(() => {
      var T;
      S.value = new Dropdown((T = y.value) == null ? void 0 : T.$el, {
      ...
      createVNode(Ke, mergeProps({
        ...
        size: e.size,
        class: [unref(V), unref(p) ? e.splitClass : e.toggleClass],
        disabled: unref(c),
      ...
      unref(p) ? (openBlock(), createBlock(Ke, mergeProps({
        key: 0,
        variant: e.variant,
        size: e.size,
        disabled: unref(c)
...
var go = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createElementBlock("li", bo, [
...
var po = {};
var ho = { role: "presentation" };
var yo = { class: "px-4 py-3" };
function Bo(e, t) {
  return openBlock(), createElementBlock("li", ho, [
    createBaseVNode("form", yo, [
      renderSlot(e.$slots, "default")
    ])
  ]);
}
var $o = Be(po, [["render", Bo]]);
var ko = { role: "presentation" };
var So = ["id", "aria-describedby"];
var Co = {
  inheritAttrs: false
};
var wo = defineComponent({
  ...
  setup(e) {
    ...
    return (i, c) => (openBlock(), createElementBlock("li", ko, [
...
var To = {};
var Vo = { class: "dropdown-header" };
function _o(e, t) {
  return openBlock(), createElementBlock("li", null, [
    createBaseVNode("h6", Vo, [
      renderSlot(e.$slots, "default")
    ])
  ]);
}
var Ao = Be(To, [["render", _o]]);
var xo = {
  inheritAttrs: false
};
var Io = defineComponent({
  ...
  emits: ["click"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "active")), n = r(toRef(a, "disabled")), i = useAttrs(), c = computed(() => ({
      active: l.value,
      disabled: n.value,
    ...
    return (g, B) => (openBlock(), createElementBlock("li", {
      ...
      (openBlock(), createBlock(resolveDynamicComponent(unref(f)), mergeProps({
        class: ["dropdown-item", [unref(c), e.linkClass]]
      }, unref(v), { onClick: b }), {
        default: withCtx(() => [
...
var zo = { role: "presentation" };
var Po = { class: "px-4 py-1 mb-0 text-muted" };
var No = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createElementBlock("li", zo, [
      createBaseVNode("p", Po, [
        renderSlot(t.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
      ])
...
var Wa = defineComponent({
  ...
  emits: ["submit"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "floating")), n = r(toRef(a, "novalidate")), i = r(toRef(a, "validated")), c = computed(() => ({
...
var Do = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createElementBlock("div", Eo, [
      renderSlot(t.$slots, "default", {}, () => [
        createTextVNode(toDisplayString(e.text), 1)
      ]),
...
var xt = defineComponent({
  ...
  setup(e) {
    ...
    return (v, b) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), mergeProps({ class: unref(c) }, unref(f)), {
      default: withCtx(() => [
        renderSlot(v.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
...
var It = defineComponent({
  ...
  setup(e) {
    ...
    return (i, c) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), mergeProps({ class: unref(l) }, unref(n)), {
      default: withCtx(() => [
        renderSlot(i.$slots, "default", {}, () => [
          createTextVNode(toDisplayString(e.text), 1)
        ])
...
var qo = ["id", "disabled", "required", "name", "form", "aria-label", "aria-labelledby", "aria-required", "value", "indeterminate"];
var Ro = ["for"];
var jo = {
  inheritAttrs: false
};
var Xa = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    ), n = r(toRef(a, "autofocus")), i = r(toRef(a, "plain")), c = r(toRef(a, "button")), f = r(toRef(a, "switch")), v = r(toRef(a, "disabled")), b = r(toRef(a, "inline")), g = r(toRef(a, "required")), B = r(toRef(a, "state")), p = he(toRef(a, "id"), "form-check"), k = ref(null), C = ref(false), y = computed({
    ...
    }), S = computed(() => Array.isArray(a.modelValue) ? a.modelValue.indexOf(a.value) > -1 : JSON.stringify(a.modelValue) === JSON.stringify(a.value)), $ = reactive({
      plain: toRef(i, "value"),
    ...
    return onMounted(() => {
      ...
      withDirectives(createBaseVNode("input", mergeProps({ id: unref(p) }, A.$attrs, {
        ref_key: "input",
        ref: k,
        ...
        onFocus: I[1] || (I[1] = (M) => C.value = true),
        onBlur: I[2] || (I[2] = (M) => C.value = false)
      }), null, 16, qo), [
      ...
      A.$slots.default || !unref(i) ? (openBlock(), createElementBlock("label", {
        key: 0,
        for: unref(p),
        class: normalizeClass([unref(V), { active: unref(S), focus: C.value }])
      }, [
...
var Wo = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    r(toRef(a, "plain"));
    const i = r(toRef(a, "required")), c = r(toRef(a, "stacked")), f = r(toRef(a, "state")), v = r(toRef(a, "switches")), b = r(toRef(a, "validated")), g = useSlots(), B = "BFormCheckbox", p = he(toRef(a, "id"), "checkbox"), k = he(toRef(a, "name"), "checkbox"), C = computed({
      get: () => a.modelValue,
      set: (L) => {
    ...
    return (L, V) => (openBlock(), createElementBlock("div", mergeProps(unref($), {
      id: unref(p),
      role: "group",
      class: [unref(z), "bv-no-focus-ring"],
      tabindex: "-1"
    }), [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(y), (A, I) => (openBlock(), createBlock(Xa, mergeProps({
        key: I,
        modelValue: unref(C),
        "onUpdate:modelValue": V[0] || (V[0] = (M) => isRef(C) ? C.value = M : null)
      }, A.props), {
        default: withCtx(() => [
          A.html ? (openBlock(), createElementBlock("span", {
            key: 0,
            innerHTML: A.html
          }, null, 8, Go)) : (openBlock(), createElementBlock("span", {
            key: 1,
...
var Xo = Ka.map((e) => `${e}:not([disabled])`).join();
var Ko = [...Ka, "a", "button", "label"];
var Jo = "label";
var Yo = "invalid-feedback";
var Zo = "valid-feedback";
var Qo = "description";
var es = "default";
var ts = defineComponent({
  ...
  setup(e, { attrs: t }) {
    const a = r(toRef(e, "disabled")), l = r(toRef(e, "labelSrOnly")), n = r(toRef(e, "state")), i = r(toRef(e, "tooltip")), c = r(toRef(e, "validated")), f = r(toRef(e, "floating")), v = null, b = ["xs", "sm", "md", "lg", "xl"], g = (I, M) => b.reduce((_, T) => {
      const D = Ut(T === "xs" ? "" : T, `${M}Align`), R = I[D] || null;
      return R && (T === "xs" ? _.push(`text-${R}`) : _.push(`text-${T}-${R}`)), _;
    }, []), B = (I, M) => b.reduce((_, T) => {
      const D = Ut(T === "xs" ? "" : T, `${M}Cols`);
      let R = I[D];
      return R = R === "" ? true : R || false, typeof R != "boolean" && R !== "auto" && (R = Ue(R, 0), R = R > 0 ? R : false), R && (T === "xs" ? _.cols = R : _[T || (typeof R == "boolean" ? "col" : "cols")] = R), _;
    }, {}), p = ref(), k = (I, M = null) => {
      if (Ol && e.labelFor) {
    ...
    }, C = computed(() => B(e, "content")), y = computed(() => g(e, "label")), S = computed(() => B(e, "label")), $ = computed(
  ...
  render() {
    ...
    if (i || this.isHorizontal) {
      ...
      if (this.labelSrOnlyBoolean)
        i && (n = h(
          ...
          i
        )), this.isHorizontal ? n = h(We, this.labelColProps, { default: () => n }) : n = h("div", {}, [n]);
      else {
        const A = {
        ...
        this.isHorizontal ? n = h(We, A, { default: () => i }) : n = h(V, A, i);
      }
    }
    let f = null;
    ...
    this.isHorizontal && (z = h(We, { ref: "content", ...this.contentColProps }, { default: () => $ }));
    const L = {
      class: [
        "mb-3",
        this.stateClass,
...
var ls = ["id", "name", "form", "type", "disabled", "placeholder", "required", "autocomplete", "readonly", "min", "max", "step", "list", "aria-required", "aria-invalid"];
...
var os = Be(as, [["render", ns]]);
var ss = ["id", "disabled", "required", "name", "form", "aria-label", "aria-labelledby", "value", "aria-required"];
var rs = ["for"];
var Ja = defineComponent({
  __name: "BFormRadio",
  props: {
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "autofocus")), n = r(toRef(a, "plain")), i = r(toRef(a, "button")), c = r(toRef(a, "switch")), f = r(toRef(a, "disabled")), v = r(toRef(a, "inline")), b = r(toRef(a, "required")), g = r(toRef(a, "state")), B = he(toRef(a, "id"), "form-check"), p = ref(null), k = ref(false), C = computed({
      get: () => Array.isArray(a.modelValue) ? a.modelValue[0] : a.modelValue,
      set: (V) => {
        const A = V ? a.value : false, I = Array.isArray(a.modelValue) ? [A] : A;
        t("input", I), t("change", I), t("update:modelValue", I);
      }
    }), y = computed(() => Array.isArray(a.modelValue) ? (a.modelValue || []).find((V) => V === a.value) : JSON.stringify(a.modelValue) === JSON.stringify(a.value)), S = reactive({
      plain: toRef(n, "value"),
    ...
    return onMounted(() => {
    ...
    }), (V, A) => (openBlock(), createElementBlock("div", {
      class: normalizeClass(unref($))
    }, [
      withDirectives(createBaseVNode("input", mergeProps({ id: unref(B) }, V.$attrs, {
        ref_key: "input",
        ref: p,
        "onUpdate:modelValue": A[0] || (A[0] = (I) => isRef(C) ? C.value = I : null),
        class: unref(z),
        type: "radio",
        disabled: unref(f),
      ...
      V.$slots.default || !unref(n) ? (openBlock(), createElementBlock("label", {
        key: 0,
        for: unref(B),
...
var cs = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    const l = r(toRef(a, "buttons")), n = r(toRef(a, "disabled"));
    r(toRef(a, "plain"));
    const i = r(toRef(a, "required")), c = r(toRef(a, "stacked")), f = r(toRef(a, "state")), v = r(toRef(a, "validated")), b = useSlots(), g = "BFormRadio", B = he(toRef(a, "id"), "radio"), p = he(toRef(a, "name"), "checkbox"), k = computed({
      get: () => a.modelValue,
      set: (z) => {
    ...
    return (z, L) => (openBlock(), createElementBlock("div", mergeProps(unref(S), {
      id: unref(B),
      role: "radiogroup",
      class: [unref($), "bv-no-focus-ring"],
      tabindex: "-1"
    }), [
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(C), (V, A) => (openBlock(), createBlock(Ja, mergeProps({
        key: A,
        modelValue: unref(k),
        ...
        default: withCtx(() => [
          V.html ? (openBlock(), createElementBlock("span", {
            key: 0,
            innerHTML: V.html
          }, null, 8, us)) : (openBlock(), createElementBlock("span", {
            key: 1,
...
var Ya = defineComponent({
  ...
  setup(e) {
    ...
    return (l, n) => (openBlock(), createElementBlock("optgroup", { label: e.label }, [
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(a), (i, c) => (openBlock(), createBlock(qt, mergeProps({
        key: `option_${c}`,
        value: i.value,
        disabled: i.disabled
      }, l.$attrs, {
...
var ms = ["id", "name", "form", "multiple", "size", "disabled", "required", "aria-required", "aria-invalid"];
var bs = defineComponent({
  ...
  emits: ["input", "update:modelValue", "change"],
  setup(e, { expose: t, emit: a }) {
    const l = e, n = r(toRef(l, "autofocus")), i = r(toRef(l, "disabled")), c = r(toRef(l, "multiple")), f = r(toRef(l, "plain")), v = r(toRef(l, "required")), b = r(toRef(l, "state")), g = ref(), B = he(toRef(l, "id"), "input"), p = () => {
      nextTick(() => {
        var V;
        n.value && ((V = g.value) == null || V.focus());
      });
    };
    onMounted(p), onActivated(p);
    const k = computed(() => ({
    ...
    return t({
    ...
    }), (V, A) => withDirectives((openBlock(), createElementBlock("select", mergeProps({
      id: unref(B),
      ref_key: "input",
      ref: g
    }, V.$attrs, {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(S), (I, M) => (openBlock(), createElementBlock(Fragment, null, [
        Array.isArray(I.options) ? (openBlock(), createBlock(Ya, {
          key: `option_${M}`,
          label: I.label,
          options: I.options
...
var Za = defineComponent({
  ...
  emits: ["remove"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "disabled")), n = r(toRef(a, "noRemove")), i = r(toRef(a, "pill")), c = useSlots(), f = computed(
      () => {
        var B, p, k;
        return (k = ((p = (B = c.default) == null ? void 0 : B.call(c)[0].children) == null ? void 0 : p.toString()) || a.title) != null ? k : "";
      }
    ), v = he(toRef(a, "id")), b = computed(() => `${v.value}taglabel__`), g = computed(() => [
      `bg-${a.variant}`,
      {
    ...
    return (B, p) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      id: unref(v),
      title: unref(f),
      ...
      default: withCtx(() => [
        ...
        !unref(l) && !unref(n) ? (openBlock(), createBlock(Ge, {
          ...
          "aria-controls": e.id,
          onClick: p[0] || (p[0] = (k) => t("remove", unref(f)))
...
var Ss = ["id", "disabled", "value", "type", "placeholder", "form", "required"];
var Cs = ["disabled"];
var ws = {
  "aria-live": "polite",
  "aria-atomic": "true"
...
var xs = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "addOnChange")), n = r(toRef(a, "autofocus")), i = r(toRef(a, "disabled")), c = r(toRef(a, "noAddOnEnter")), f = r(toRef(a, "noOuterFocus")), v = r(toRef(a, "noTagRemove")), b = r(toRef(a, "removeOnDelete")), g = r(toRef(a, "required")), B = r(toRef(a, "state")), p = r(toRef(a, "tagPills")), k = ref(null), C = he(), y = computed(() => a.inputId || `${C.value}input__`);
    onMounted(() => {
      ae(), a.modelValue.length > 0 && (z.value = true);
    }), onActivated(() => ae()), watch(
      () => a.modelValue,
      (X) => {
        S.value = X;
      }
    );
    const S = ref(a.modelValue), $ = ref(""), z = ref(false), L = ref(false), V = ref(""), A = ref([]), I = ref([]), M = ref([]), _ = computed(() => ({
      [`form-control-${a.size}`]: a.size !== void 0,
      disabled: i.value,
      focus: L.value,
      "is-invalid": B.value === false,
      "is-valid": B.value === true
    })), T = computed(() => S.value.includes($.value)), D = computed(
      () => $.value === "" ? false : !a.tagValidator($.value)
    ), R = computed(() => S.value.length === a.limit), ne = computed(() => !D.value && !T.value), ae = () => {
      var X;
      ...
      i.value || f.value || (L.value = true, t("focus", X));
    }, se = (X) => {
      L.value = false, t("blur", X);
    }, ee = (X) => {
      var G, be;
      const te = typeof X == "string" ? X : X.target.value;
      if (z.value = false, ((G = a.separator) == null ? void 0 : G.includes(te.charAt(0))) && te.length > 0) {
      ...
      (X.key === "Backspace" || X.key === "Delete") && b.value && $.value === "" && z.value && S.value.length > 0 ? ke(S.value[S.value.length - 1]) : z.value = true;
    }, ue = (X) => {
      var G;
      if (X = (X || $.value).trim(), X === "" || T.value || !a.tagValidator(X) || a.limit && R.value)
        return;
      const te = [...a.modelValue, X];
      $.value = "", z.value = true, t("update:modelValue", te), t("input", te), (G = k.value) == null || G.focus();
    }, ke = (X) => {
      var G;
    ...
    return (X, te) => (openBlock(), createElementBlock("div", {
      id: unref(C),
      ...
      }, toDisplayString(S.value.join(", ")), 9, hs),
      createBaseVNode("div", {
        id: `${unref(C)}removed_tags__`,
        role: "status",
        "aria-live": L.value ? "assertive" : "off",
        "aria-atomic": "true",
        class: "visually-hidden"
      }, " (" + toDisplayString(e.tagRemovedLabel) + ") " + toDisplayString(V.value), 9, ys),
      renderSlot(X.$slots, "default", normalizeProps(guardReactiveProps(unref(_e))), () => [
        createBaseVNode("ul", {
          id: `${unref(C)}tag_list__`,
          class: "b-form-tags-list list-unstyled mb-0 d-flex flex-wrap align-items-center"
        }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(S.value, (G) => (openBlock(), createBlock(Za, {
            key: G,
          ...
          createBaseVNode("li", {
            ...
            "aria-controls": `${unref(C)}tag_list__`
          }, [
            createBaseVNode("div", ks, [
              ...
              unref(ne) ? (openBlock(), createElementBlock("button", {
                ...
                style: { "font-size": "90%" },
                disabled: unref(i) || $.value.length === 0 || unref(R),
        ...
        createBaseVNode("div", ws, [
          unref(D) ? (openBlock(), createElementBlock("div", Ts, toDisplayString(e.invalidTagText) + ": " + toDisplayString($.value), 1)) : createCommentVNode("", true),
          unref(T) ? (openBlock(), createElementBlock("small", Vs, toDisplayString(e.duplicateTagText) + ": " + toDisplayString($.value), 1)) : createCommentVNode("", true),
          S.value.length === e.limit ? (openBlock(), createElementBlock("small", _s, "Tag limit reached")) : createCommentVNode("", true)
        ])
      ]),
      e.name ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(S.value, (G) => (openBlock(), createElementBlock("input", {
        key: G,
        type: "hidden",
        name: e.name,
        value: G
      }, null, 8, As))), 128)) : createCommentVNode("", true)
    ], 42, ps));
  }
});
...
var Fs = ["id", "name", "form", "disabled", "placeholder", "required", "autocomplete", "readonly", "aria-required", "aria-invalid", "rows", "wrap"];
...
var qs = defineComponent({
  ...
  setup(e) {
    ...
    return (i, c) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      id: e.id,
      ...
      default: withCtx(() => [
        renderSlot(i.$slots, "prepend", {}, () => [
          unref(n) ? (openBlock(), createElementBlock("span", Ps, [
            e.prependHtml ? (openBlock(), createElementBlock("span", {
              key: 0,
              innerHTML: e.prependHtml
            }, null, 8, Ns)) : (openBlock(), createElementBlock("span", Ls, toDisplayString(e.prepend), 1))
          ])) : createCommentVNode("", true)
        ]),
        renderSlot(i.$slots, "default"),
        renderSlot(i.$slots, "append", {}, () => [
          unref(l) ? (openBlock(), createElementBlock("span", Es, [
            e.appendHtml ? (openBlock(), createElementBlock("span", {
              key: 0,
              innerHTML: e.appendHtml
            }, null, 8, Hs)) : (openBlock(), createElementBlock("span", Ds, toDisplayString(e.append), 1))
          ])) : createCommentVNode("", true)
        ])
      ]),
      _: 3
...
var Rt = defineComponent({
  ...
  setup(e) {
    ...
    return (l, n) => unref(a) ? (openBlock(), createBlock(Qa, { key: 0 }, {
      default: withCtx(() => [
        renderSlot(l.$slots, "default")
      ]),
      _: 3
...
var Rs = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createBlock(Rt, { "is-text": e.isText }, {
      default: withCtx(() => [
        renderSlot(t.$slots, "default")
      ]),
      _: 3
...
var Ms = defineComponent({
  ...
  setup(e) {
    ...
    return provide(el, {
      numbered: l.value
    }), (c, f) => (openBlock(), createBlock(resolveDynamicComponent(unref(i)), {
...
var Gs = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "action")), l = r(toRef(t, "active")), n = r(toRef(t, "button")), i = r(toRef(t, "disabled")), c = useAttrs(), f = inject(el, null), v = computed(() => !n.value && (!!t.href || !!t.to)), b = computed(
      ...
      const p = {};
      return n.value && ((!c || !c.type) && (p.type = "button"), i.value && (p.disabled = true)), p;
    });
    return (p, k) => (openBlock(), createBlock(resolveDynamicComponent(unref(b)), mergeProps({
...
var Xs = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "busy")), n = r(toRef(a, "lazy")), i = r(toRef(a, "cancelDisabled")), c = r(toRef(a, "centered")), f = r(toRef(a, "headerCloseWhite")), v = r(toRef(a, "hideBackdrop")), b = r(toRef(a, "hideFooter")), g = r(toRef(a, "hideHeader")), B = r(toRef(a, "hideHeaderClose")), p = r(toRef(a, "modelValue")), k = r(toRef(a, "noCloseOnBackdrop")), C = r(toRef(a, "noCloseOnEsc")), y = r(toRef(a, "noFade")), S = r(toRef(a, "noFocus")), $ = r(toRef(a, "okDisabled")), z = r(toRef(a, "okOnly")), L = r(toRef(a, "scrollable")), V = r(toRef(a, "show")), A = r(toRef(a, "titleSrOnly")), I = ref(false), M = he(toRef(a, "id"), "modal"), _ = ref(), T = ref(), D = computed(() => [
      {
        fade: !y.value,
        show: V.value
      },
      ...
      a.titleClass
    ]), se = computed(() => i.value || l.value), ee = computed(() => $.value || l.value);
    ve(_, "shown.bs.modal", (G) => Z(G)), ve(_, "hidden.bs.modal", (G) => $e(G)), ve(_, "show.bs.modal", (G) => ue(G)), ve(_, "hide.bs.modal", (G) => ke(G));
    const Z = (G) => {
      t("shown", G), n.value === true && (I.value = true), p.value === false && t("update:modelValue", true), G.target.focus();
    }, $e = (G) => {
      t("hidden", G), n.value === true && (I.value = false), p.value === true && t("update:modelValue", false);
      ...
      p.value && t("update:modelValue", true), te().show();
    }, X = () => {
      p.value && t("update:modelValue", false), te().hide();
    }, te = () => (T.value !== void 0 || (T.value = new Modal(_.value, {
      backdrop: false,
      keyboard: !C.value,
      focus: !S.value
    })), T.value);
    return onMounted(() => {
      ...
      () => a.noCloseOnBackdrop,
      (G) => {
        te()._config.backdrop = a.hideBackdrop ? false : G ? "static" : !a.hideBackdrop;
      }
    ), watch(
      () => a.noCloseOnEsc,
      (G) => {
      ...
      createBaseVNode("div", mergeProps({
        ...
        createBaseVNode("div", {
          class: normalizeClass(["modal-dialog", unref(R)])
        }, [
          !unref(n) || unref(n) && I.value || unref(n) && unref(p) === true ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: normalizeClass(["modal-content", e.contentClass])
          }, [
            unref(g) ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", {
              key: 0,
              class: normalizeClass(["modal-header", unref(ae)])
            }, [
            ...
            createBaseVNode("div", {
              class: normalizeClass(["modal-body", unref(ne)])
            }, [
        ...
        unref(v) === false ? (openBlock(), createElementBlock("div", {
          ...
          onClick: be[4] || (be[4] = withModifiers((Ae) => unref(k) === false && X(), ["prevent"]))
        })) : createCommentVNode("", true)
      ], 16, Us)
    ]));
  }
});
var Ks = Be(Xs, [["__scopeId", "data-v-f7e6d64f"]]);
var Js = defineComponent({
  __name: "BNav",
  props: {
    align: null,
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "cardHeader")), l = r(toRef(t, "fill")), n = r(toRef(t, "justified")), i = r(toRef(t, "pills")), c = r(toRef(t, "small")), f = r(toRef(t, "tabs")), v = r(toRef(t, "vertical")), b = computed(() => ({
      "nav-tabs": f.value,
...
var Ys = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    return (i, c) => (openBlock(), createBlock(Wa, mergeProps(unref(n), {
      class: "d-flex",
...
var Qs = { class: "nav-item" };
function er(e, t, a, l, n, i) {
  const c = resolveComponent("b-link");
  return openBlock(), createElementBlock("li", Qs, [
...
var tr = Be(Zs, [["render", er]]);
var ar = { class: "nav-item dropdown" };
var lr = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createElementBlock("li", ar, [
      createVNode(Ua, mergeProps(t.$props, { "is-nav": "" }), createSlots({ _: 2 }, [
...
var or = defineComponent({
  ...
  setup(e) {
    return (t, a) => (openBlock(), createElementBlock("li", nr, [
      renderSlot(t.$slots, "default", {}, () => [
        createTextVNode(toDisplayString(e.text), 1)
      ])
    ]));
...
var sr = defineComponent({
  ...
  setup(e) {
    ...
    return (v, b) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      class: normalizeClass(["navbar", unref(f)]),
      role: unref(n)
    }, {
      default: withCtx(() => [
...
var dr = defineComponent({
  ...
  setup(e) {
    ...
    return (c, f) => (openBlock(), createElementBlock("ul", {
...
var cr = createBaseVNode("span", { class: "navbar-toggler-icon" }, null, -1);
var fr = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    return (f, v) => withDirectives((openBlock(), createElementBlock("button", mergeProps({
      ...
      [unref(Et), unref(l) ? void 0 : e.target]
    ]);
  }
});
...
var hr = defineComponent({
  ...
  emits: ["update:modelValue", "show", "shown", "hide", "hidden"],
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "modelValue")), n = r(toRef(a, "bodyScrolling")), i = r(toRef(a, "backdrop")), c = r(toRef(a, "noHeaderClose")), f = r(toRef(a, "noHeader")), v = ref(), b = ref();
    ...
    return watch(
    ...
    ), (k, C) => (openBlock(), createElementBlock("div", {
      ref_key: "element",
      ref: v,
      ...
      unref(f) ? createCommentVNode("", true) : (openBlock(), createElementBlock("div", mr, [
        renderSlot(k.$slots, "header", normalizeProps(guardReactiveProps({ visible: e.modelValue, placement: e.placement, hide: B })), () => [
          createBaseVNode("h5", br, [
            renderSlot(k.$slots, "title", {}, () => [
              createTextVNode(toDisplayString(e.title), 1)
            ])
          ]),
          unref(c) ? createCommentVNode("", true) : (openBlock(), createBlock(Ge, {
            key: 0,
            type: "button",
            class: "text-reset",
...
var $r = defineComponent({
  ...
  setup(e, { slots: t, emit: a }) {
    const l = r(toRef(e, "fixed")), n = r(toRef(e, "noCenter")), i = r(toRef(e, "noFade")), c = r(toRef(e, "noWrap")), f = r(toRef(e, "show")), v = r(toRef(e, "spinnerSmall")), b = computed(
      () => e.rounded === true || e.rounded === "" ? "rounded" : e.rounded ? `rounded-${e.rounded}` : ""
    ), g = computed(
    ...
    return () => {
      const p = (S) => h(resolveComponent("BSpinner"), {
        type: S.spinnerType,
...
var al = 0;
var Ve = 3;
var Sr = "ellipsis-text";
var Cr = "first-text";
var wr = "last-text";
var Tr = "next-text";
var Vr = "page";
var _r = "prev-text";
var na = (e) => Math.max(je(e) || tl, 1);
var oa = (e) => Math.max(je(e) || al, 0);
var Ar = (e, t) => {
  const a = je(e) || 1;
...
var xr = defineComponent({
  ...
  setup(e, { emit: t, slots: a }) {
    const l = r(toRef(e, "disabled")), n = r(toRef(e, "firstNumber")), i = r(toRef(e, "hideEllipsis")), c = r(toRef(e, "hideGotoEndButtons")), f = r(toRef(e, "lastNumber")), v = r(toRef(e, "pills")), b = Cl(toRef(e, "align")), g = computed(
      ...
      let A = false;
      return V + 2 < e.limit && e.limit > Ve ? e.limit > Ve && (A = true) : e.limit > Ve && (A = !!(!i.value || n.value)), B.value <= 1 && (A = false), A && n.value && B.value < 4 && (A = false), A;
    }), k = computed(() => {
      let V = e.limit;
      ...
      let A = false;
      e.modelValue < e.limit - 1 && e.limit > Ve ? (!i.value || f.value) && (A = true) : e.limit > Ve && (A = !!(!i.value || f.value)), B.value > V && (A = false);
      const I = B.value + k.value - 1;
      return A && f.value && I > g.value - 3 && (A = false), A;
    }), y = reactive({
    ...
    return () => {
      ...
      V.push(ne), n.value && A[0] !== 1 && V.push(R({ number: 1 }, 0)), p.value && V.push(D(false)), L.value.forEach((K, de) => {
        const se = p.value && n.value && A[0] !== 1 ? 1 : 0;
        V.push(R(K, de + se));
      }), C.value && V.push(D(true)), f.value && A[A.length - 1] !== g.value && V.push(R({ number: g.value }, -1));
      const ae = T(
        e.modelValue + 1,
        e.labelNextPage,
        Tr,
...
var Ir = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "noButton")), l = r(toRef(t, "noHeader")), n = r(toRef(t, "noFooter")), i = r(toRef(t, "noImg")), c = r(toRef(t, "imgBottom")), f = computed(() => ({
      width: t.headerWidth,
    ...
    return (g, B) => (openBlock(), createBlock(Da, { "img-bottom": unref(c) }, createSlots({
      default: withCtx(() => [
        renderSlot(g.$slots, "default", {}, () => [
      ...
      unref(n) ? void 0 : {
        ...
        fn: withCtx(() => [
          renderSlot(g.$slots, "footer", {}, () => [
            unref(a) ? (openBlock(), createBlock(we, normalizeProps(mergeProps({ key: 1 }, unref(v))), null, 16)) : (openBlock(), createBlock(ll, normalizeProps(mergeProps({ key: 0 }, unref(v))), null, 16))
          ])
        ]),
        key: "2"
      }
...
var vt = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "captionTop")), l = r(toRef(t, "borderless")), n = r(toRef(t, "bordered")), i = r(toRef(t, "dark")), c = r(toRef(t, "hover")), f = r(toRef(t, "small")), v = r(toRef(t, "striped")), b = r(toRef(t, "stickyHeader")), g = computed(() => [
      "table",
      "b-table",
      {
    ...
    return (p, k) => e.responsive ? (openBlock(), createElementBlock("div", {
      key: 1,
...
var Fr = defineComponent({
  ...
  setup(e) {
    ...
    return (B, p) => (openBlock(), createBlock(vt, null, {
      default: withCtx(() => [
        unref(b) ? createCommentVNode("", true) : renderSlot(B.$slots, "thead", { key: 0 }, () => [
          createBaseVNode("thead", null, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n), (k, C) => (openBlock(), createElementBlock("th", { key: C }, [
                createVNode(we, normalizeProps(guardReactiveProps(unref(f))), null, 16)
              ]))), 128))
            ])
          ])
        ...
        renderSlot(B.$slots, "default", {}, () => [
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(l), (k, C) => (openBlock(), createElementBlock("tr", { key: C }, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(a), (y, S) => (openBlock(), createElementBlock("td", { key: S }, [
                createVNode(we, normalizeProps(guardReactiveProps(unref(c))), null, 16)
              ]))), 128))
            ]))), 128))
          ])
        ]),
        unref(g) ? renderSlot(B.$slots, "tfoot", { key: 1 }, () => [
          createBaseVNode("tfoot", null, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(i), (k, C) => (openBlock(), createElementBlock("th", { key: C }, [
...
var zr = defineComponent({
  ...
  setup(e, { emit: t, slots: a }) {
    ...
    const l = r(toRef(e, "show")), n = r(toRef(e, "html")), i = r(toRef(e, "sanitize")), c = ref(), f = ref(), v = ref(), b = ref(), g = ref(), B = computed(() => ({
      ...
      f.value = k(p(y)), f.value && (v.value = new Popover(f.value, {
...
var Hr = Be(zr, [["render", Er]]);
var Dr = ["aria-valuenow", "aria-valuemax"];
var nl = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "animated")), l = r(toRef(t, "showProgress")), n = r(toRef(t, "showValue")), i = r(toRef(t, "striped")), c = inject(ol), f = computed(() => ({
    ...
    return (k, C) => (openBlock(), createElementBlock("div", {
      class: normalizeClass(["progress-bar", unref(f)]),
      role: "progressbar",
...
var qr = defineComponent({
  ...
  setup(e) {
    const t = e, a = r(toRef(t, "animated")), l = r(toRef(t, "showProgress")), n = r(toRef(t, "showValue")), i = r(toRef(t, "striped")), c = computed(() => ({
      animated: a.value,
      max: t.max,
    ...
    return provide(ol, {
      ...
      renderSlot(f.$slots, "default", {}, () => [
        createVNode(nl, normalizeProps(guardReactiveProps(unref(c))), null, 16)
      ])
    ], 4));
  }
});
var sa = ct("cols", [""], { type: [String, Number], default: null });
var Rr = defineComponent({
  name: "BRow",
  props: {
    tag: { type: String, default: "div" },
  ...
  setup(e) {
    const t = r(toRef(e, "noGutters")), a = pa(e, sa, "cols", "row-cols");
    return {
      classes: computed(() => ({
        [`gx-${e.gutterX}`]: e.gutterX !== null,
        [`gy-${e.gutterY}`]: e.gutterY !== null,
...
var Xr = defineComponent({
  ...
  setup(e) {
    ...
    return (n, i) => (openBlock(), createBlock(vt, normalizeProps(guardReactiveProps(e.tableProps)), {
      default: withCtx(() => [
        unref(a) ? createCommentVNode("", true) : (openBlock(), createElementBlock("thead", Ur, [
          createBaseVNode("tr", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(e.columns, (c, f) => (openBlock(), createElementBlock("th", { key: f }, [
              createVNode(at)
            ]))), 128))
          ])
        ])),
        createBaseVNode("tbody", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(e.rows, (c, f) => (openBlock(), createElementBlock("tr", { key: f }, [
        ...
        unref(l) ? (openBlock(), createElementBlock("tfoot", Wr, [
          createBaseVNode("tr", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(e.columns, (c, f) => (openBlock(), createElementBlock("th", { key: f }, [
              createVNode(at)
            ]))), 128))
...
var Jr = () => {
  const e = (f, v) => {
    ...
    (g) => Object.entries(g).filter((B) => {
      const [p, k] = B;
      return p[0] === "_" || b.length > 0 && !b.includes(p) ? false : (typeof k == "object" ? JSON.stringify(Object.values(k)) : typeof k == "string" ? k : k.toString()).toLowerCase().includes(v.toLowerCase());
    }).length > 0
  );
  return {
    normaliseFields: e,
...
var Yr = ["title", "abbr", "onClick"];
var Zr = { class: "d-inline-flex flex-nowrap align-items-center gap-1" };
var Qr = {
  key: 0,
  class: "b-table-sort-icon text-muted small"
};
var ei = { key: 1 };
var ti = ["onClick", "onDblclick", "onMouseenter", "onMouseleave"];
var ai = ["colspan"];
var li = ["colspan"];
var ni = { class: "d-flex align-items-center justify-content-center gap-2" };
var oi = createBaseVNode("strong", null, "Loading...", -1);
var si = {
  key: 1,
...
var vi = defineComponent({
  ...
  setup(e, { expose: t, emit: a }) {
    const l = e, n = r(toRef(l, "footClone")), i = r(toRef(l, "sortDesc")), c = r(toRef(l, "sortInternal")), f = r(toRef(l, "selectable")), v = r(toRef(l, "stickySelect")), b = r(toRef(l, "busy")), g = r(toRef(l, "showEmpty")), B = r(toRef(l, "showEmpty")), p = r(toRef(l, "showEmpty")), k = r(toRef(l, "showEmpty")), C = ref(b.value), y = useSlots(), S = computed(() => ({
    ...
    const L = computed(() => z.normaliseFields(l.fields, l.items)), V = computed(
      () => L.value.length + (f.value ? 1 : 0)
    ), A = computed(() => l.filter !== void 0 && l.filter !== ""), I = computed(() => l.provider !== void 0), M = computed(() => se.value && c.value === true), _ = computed(() => I.value ? z.internalItems.value : M.value ? z.mapItems(l.fields, l.items, l, {
      isSortable: se,
      isFilterableTable: A,
      sortDescBoolean: i
    }) : l.items), T = (w) => typeof w == "string" ? Mt(w) : w.label !== void 0 ? w.label : typeof w.key == "string" ? Mt(w.key) : w.key, D = (w, E, oe = false) => {
      const P = typeof w == "string" ? w : w.key;
      a("headClicked", P, w, E, oe), ee(w);
    }, R = (w, E, oe) => {
      a("rowClicked", w, E, oe), ke(w, E, oe.shiftKey);
    }, ne = (w, E, oe) => a("rowDblClicked", w, E, oe), ae = (w, E, oe) => a("rowHovered", w, E, oe), K = (w, E, oe) => a("rowUnhovered", w, E, oe), de = computed(
      ...
      if (!se.value)
        return;
      const E = typeof w == "string" ? w : w.key, oe = typeof w == "string" ? false : w.sortable;
      if (se.value === true && oe === true) {
        const P = !i.value;
        E !== l.sortBy && a("update:sortBy", E), a("update:sortDesc", P), a("sorted", E, P);
      }
    }, Z = ref(/* @__PURE__ */ new Set([])), $e = computed(() => Z.value.size > 0), ue = () => {
    ...
    const Ne = async (w, E, oe) => {
      if (E === oe)
        return;
      const P = (Le) => l.noProvider && l.noProvider.includes(Le), pe = ["currentPage", "perPage"].includes(w) && (P("paging") || B.value === true), ce = ["filter"].includes(w) && (P("filtering") || k.value === true), pt = ["sortBy", "sortDesc"].includes(w) && (P("sorting") || p.value === true);
      pe || ce || pt || await _e();
    };
    return watch(
      () => C.value,
      ...
      selectRow: bt,
      unselectRow: gt
    }), (w, E) => (openBlock(), createBlock(vt, normalizeProps(guardReactiveProps(unref($))), {
      default: withCtx(() => {
        var oe;
        return [
          createBaseVNode("thead", null, [
            ...
            createBaseVNode("tr", null, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(L), (P) => (openBlock(), createElementBlock("th", mergeProps({
                key: P.key,
                scope: "col",
                class: te(P),
                title: P.headerTitle,
                ...
                createBaseVNode("div", Zr, [
                  renderSlot(w.$slots, "sort-icon", {
                    ...
                    unref(se) && P.sortable && P.key === e.sortBy ? (openBlock(), createElementBlock("span", Qr)) : createCommentVNode("", true)
                  ]),
                  createBaseVNode("div", null, [
                    w.$slots["head(" + P.key + ")"] || w.$slots["head()"] ? renderSlot(w.$slots, w.$slots["head(" + P.key + ")"] ? "head(" + P.key + ")" : "head()", {
                      key: 0,
                      label: P.label
                    }) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      createTextVNode(toDisplayString(T(P)), 1)
                    ], 64))
                  ])
                ])
              ], 16, Yr))), 128))
            ]),
            w.$slots["thead-sub"] ? (openBlock(), createElementBlock("tr", ei, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(L), (P) => (openBlock(), createElementBlock("td", {
                key: P.key,
                scope: "col",
                class: normalizeClass([P.class, P.thClass, P.variant ? `table-${P.variant}` : ""])
              }, [
                w.$slots["thead-sub"] ? renderSlot(w.$slots, "thead-sub", mergeProps({
                  key: 0,
                  items: unref(L)
                }, P)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          ...
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(_), (P, pe) => (openBlock(), createElementBlock(Fragment, { key: pe }, [
              createBaseVNode("tr", {
                class: normalizeClass(be(P)),
                ...
                unref(de) ? (openBlock(), createElementBlock("td", {
                  ...
                  renderSlot(w.$slots, "select-cell", {}, () => [
                    createBaseVNode("span", {
                      class: normalizeClass(Z.value.has(P) ? "text-primary" : "")
                    }, "\u{1F5F9}", 2)
                  ])
                ], 2)) : createCommentVNode("", true),
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(L), (ce) => (openBlock(), createElementBlock("td", mergeProps({
                  key: ce.key
                }, ce.tdAttr, {
                  class: G(ce, P)
                }), [
                  w.$slots["cell(" + ce.key + ")"] || w.$slots["cell()"] ? renderSlot(w.$slots, w.$slots["cell(" + ce.key + ")"] ? "cell(" + ce.key + ")" : "cell()", {
                    key: 0,
                    value: P[ce.key],
                    index: pe,
                    item: P,
                    ...
                    createTextVNode(toDisplayString(P[ce.key]), 1)
                  ], 64))
                ], 16))), 128))
              ], 42, ti),
              P._showDetails === true && w.$slots["row-details"] ? (openBlock(), createElementBlock("tr", {
                key: 0,
                class: normalizeClass(be(P))
              }, [
                createBaseVNode("td", { colspan: unref(V) }, [
            ...
            C.value ? (openBlock(), createElementBlock("tr", {
              key: 0,
            ...
            unref(g) && unref(_).length === 0 ? (openBlock(), createElementBlock("tr", si, [
              createBaseVNode("td", { colspan: unref(V) }, [
          ...
          unref(n) ? (openBlock(), createElementBlock("tfoot", ii, [
            createBaseVNode("tr", null, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(L), (P) => (openBlock(), createElementBlock("th", mergeProps({
                key: P.key
              }, P.thAttr, {
                ...
                abbr: P.headerAbbr,
                style: P.thStyle,
                onClick: (pe) => D(P, pe, true)
              }), toDisplayString(P.label), 17, ui))), 128))
            ])
          ])) : w.$slots["custom-foot"] ? (openBlock(), createElementBlock("tfoot", di, [
            renderSlot(w.$slots, "custom-foot", {
              fields: unref(L),
              items: e.items,
              columns: (oe = unref(L)) == null ? void 0 : oe.length
            })
          ])) : createCommentVNode("", true),
          w.$slots["table-caption"] ? (openBlock(), createElementBlock("caption", ci, [
            renderSlot(w.$slots, "table-caption")
          ])) : e.caption ? (openBlock(), createElementBlock("caption", fi, toDisplayString(e.caption), 1)) : createCommentVNode("", true)
        ];
      }),
      _: 3
    }, 16));
...
var bi = ["scope", "colspan", "rowspan", "data-label"];
var gi = { key: 0 };
var pi = defineComponent({
  ...
  setup(e) {
    ...
    return (i, c) => (openBlock(), createElementBlock("td", {
      role: "cell",
      scope: unref(n),
      class: normalizeClass(unref(l)),
      colspan: e.colspan,
      ...
      e.stackedHeading ? (openBlock(), createElementBlock("div", gi, [
        renderSlot(i.$slots, "default")
...
var yi = ["scope", "colspan", "rowspan", "data-label"];
var Bi = { key: 0 };
var $i = defineComponent({
  ...
  setup(e) {
    ...
    return (i, c) => (openBlock(), createElementBlock("th", {
      role: "columnheader",
      scope: unref(n),
      class: normalizeClass(unref(l)),
      colspan: e.colspan,
...
var Ci = ["id", "data-bs-target", "aria-controls", "aria-selected", "onClick"];
var sl = Symbol();
var wi = defineComponent({
  ...
  setup(e, { emit: t }) {
    const a = e, l = r(toRef(a, "card")), n = r(toRef(a, "end")), i = r(toRef(a, "fill")), c = r(toRef(a, "justified")), f = r(toRef(a, "lazy")), v = r(toRef(a, "noFade")), b = r(toRef(a, "noNavStyle")), g = r(toRef(a, "pills")), B = r(toRef(a, "small")), p = r(toRef(a, "vertical")), k = useSlots(), C = ref(a.modelValue), y = ref(""), S = computed({
      get: () => C.value,
      set: (_) => {
      ...
      if (_ !== void 0 && _ > -1 && _ < $.value.length && !$.value[_].disabled && (S.value < 0 || $.value[_].buttonId !== y.value)) {
        const D = new dt("activate-tab", { cancelable: true, vueTarget: this });
        t("activate-tab", _, S.value, D), D.defaultPrevented || (S.value = _, T = true);
      }
    ...
    return A(C.value), watch(
      ...
      () => {
        ...
        _ < 0 && (S.value >= $.value.length ? _ = $.value.map((T) => !T.disabled).lastIndexOf(true) : $.value[S.value] && !$.value[S.value].disabled && (_ = S.value)), _ < 0 && (_ = $.value.map((T) => !T.disabled).indexOf(true)), $.value.forEach((T, D) => T.active = D === _), A(_);
      }
    ), onMounted(() => {
      ...
      default: withCtx(() => [
        unref(n) ? (openBlock(), createElementBlock("div", {
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref($), ({ tab: D, contentId: R, tabClasses: ne, active: ae }, K) => (openBlock(), createBlock(resolveDynamicComponent(D), {
            id: R,
            key: K,
            class: normalizeClass(ne),
            active: ae
        ...
        createBaseVNode("div", {
          ...
          createBaseVNode("ul", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref($), ({ tab: D, buttonId: R, contentId: ne, navItemClasses: ae, active: K, target: de }, se) => (openBlock(), createElementBlock("li", {
              key: se,
              ...
              createBaseVNode("button", mergeProps({
                ...
                onClick: withModifiers((ee) => I(ee, se), ["stop", "prevent"])
              }), [
...
var Ti = defineComponent({
  ...
  setup(e) {
    const t = e, a = ref(false), l = r(toRef(t, "active")), n = r(toRef(t, "disabled")), i = r(toRef(t, t.lazyOnce !== void 0 ? "lazyOnce" : "lazy")), c = inject(sl, null), f = computed(() => (c == null ? void 0 : c.lazy) || i.value), v = computed(() => t.lazyOnce !== void 0), b = computed(() => l.value && !n.value), g = computed(() => {
      const p = f.value && v.value && a.value;
      return b.value || !f.value || p;
    }), B = computed(() => ({
      active: l.value,
      show: l.value,
      "card-body": (c == null ? void 0 : c.card) && t.noBody === false
    }));
    return watch(
      () => g.value,
      (p) => {
        p && !a.value && (a.value = true);
      }
    ), (p, k) => (openBlock(), createBlock(resolveDynamicComponent(e.tag), {
      id: e.id,
      ...
      default: withCtx(() => [
        unref(g) ? renderSlot(p.$slots, "default", { key: 0 }) : createCommentVNode("", true)
      ]),
      _: 3
    }, 8, ["id", "class"]));
  }
...
// dep:bootstrap-vue-3
var bootstrap_vue_3_default = Ii;
export {
  Kl as BAccordion,
